	 	...
	 	_handleAJAX: function() {
		    ...
		    this.obj.find('a[data-target="ajax"]').click(function(e){
		        ...
		        if (self.options.ajaxLoad) {
				    ...
				    // Updating hash
				    /*ioluci: The search property sets or returns the querystring part of a URL, including the question mark (?).
					...
					*/
				    ...
				    if (window.location.search) {
				        ...
				        //ioluci: The hash property sets or returns the anchor part of a URL, including the hash sign (#).
			...
			//ioluci: The onhashchange event occurs when there has been changes to the anchor part (begins with a '#' symbol) of the current URL.
